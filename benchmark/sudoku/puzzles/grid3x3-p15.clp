...
(defrule grid-values
   ...
   (assert (possible (row 2) (column 1) (value 1) (group 1) (id 4)))
   (assert (possible (row 2) (column 2) (value any) (group 1) (id 5)))
   (assert (possible (row 2) (column 3) (value 6) (group 1) (id 6)))   
   ...
   (assert (possible (row 1) (column 4) (value 8) (group 2) (id 10)))
   (assert (possible (row 1) (column 5) (value any) (group 2) (id 11)))
   (assert (possible (row 1) (column 6) (value 3) (group 2) (id 12)))
   ...
   (assert (possible (row 3) (column 6) (value 1) (group 2) (id 18)))

   (assert (possible (row 1) (column 7) (value 1) (group 3) (id 19)))
   (assert (possible (row 1) (column 8) (value any) (group 3) (id 20)))
   (assert (possible (row 1) (column 9) (value 7) (group 3) (id 21)))
   (assert (possible (row 2) (column 7) (value 5) (group 3) (id 22)))
   ...
   (assert (possible (row 6) (column 5) (value 8) (group 5) (id 44)))
   (assert (possible (row 6) (column 6) (value any) (group 5) (id 45)))

   (assert (possible (row 4) (column 7) (value 7) (group 6) (id 46)))
   (assert (possible (row 4) (column 8) (value any) (group 6) (id 47)))
   (assert (possible (row 4) (column 9) (value 3) (group 6) (id 48)))
   ...
   (assert (possible (row 8) (column 3) (value 7) (group 7) (id 60)))
   (assert (possible (row 9) (column 1) (value 2) (group 7) (id 61)))
   (assert (possible (row 9) (column 2) (value any) (group 7) (id 62)))
   (assert (possible (row 9) (column 3) (value 1) (group 7) (id 63)))   
   ...
   (assert (possible (row 9) (column 4) (value 5) (group 8) (id 70)))
   (assert (possible (row 9) (column 5) (value any) (group 8) (id 71)))
   (assert (possible (row 9) (column 6) (value 6) (group 8) (id 72)))
   ...
   (assert (possible (row 8) (column 7) (value 2) (group 9) (id 76)))
   (assert (possible (row 8) (column 8) (value any) (group 9) (id 77)))
   (assert (possible (row 8) (column 9) (value 5) (group 9) (id 78)))
